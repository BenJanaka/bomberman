...
BATCH_SIZE = 100
EXPLORATION_PROB = 0.2515
EXPLORATION_PROB_STEP_SIZE = 0.0015  # updated every 10th round
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    if self.round % 10 == 0:
        ...
        self.exploration_prob = max(0.1, self.exploration_prob - EXPLORATION_PROB_STEP_SIZE)
